...
## Corpus Check
- 44 files · ~720,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 198 nodes · 468 edges · 16 communities (12 shown, 4 thin omitted)
...
- `nextConfig` --conceptually_related_to--> `SUBDOMAIN_ROUTES map`  [INFERRED]
...
Cohesion: 0.17
Nodes (15): CrossLinkBannerProps, Step, STEPS, DEFAULT_LABEL, SectionHeaderProps, DEFAULT_DESC, DEFAULT_TITLE, defaultTech (+7 more)

### Community 1 - "Project Showcase Components"
Cohesion: 0.22
Nodes (18): ContextBadge(), STYLES, FeaturedHero(), PipelineDiagram(), ProjectCard(), ProjectCardProps, ProjectDetail(), FEATURED_IDS (+10 more)
...
Cohesion: 0.20
Nodes (15): CrossLinkBanner(), EngineeringStandards(), STANDARDS, Header(), companies, HeroSection(), HowIWork(), LanguageToggle() (+7 more)
...
Cohesion: 0.11
Nodes (25): Home(), About(), Experience(), HpcStats(), SUBTITLE, TITLE, Reveal(), RevealProps (+17 more)

### Community 6 - "Build Config & Subdomain Routing"
Cohesion: 0.18
Nodes (9): compat, __dirname, eslintConfig, __filename, nextConfig, package.json Manifest, PostCSS Config (@tailwindcss/postcss), Getting Started doc (+1 more)

### Community 7 - "Projects Data & Footer"
Cohesion: 0.27
Nodes (8): Footer(), Modal(), allProjects, getProjectById(), generateMetadata(), generateStaticParams(), ProjectModal(), ProjectPage()
...
Cohesion: 0.33
Nodes (5): inter, metadata, RootLayout(), LanguageProvider(), Default()

### Community 13 - "Community 13"
Cohesion: 0.33
Nodes (6): Global Data Inspirasi (client company), Robota product (mentioned in testimonial), Semesta Data Digital (client company), Captured portfolio gallery HTML snippet, softwareProjects, Widyawan testimonial entry
...
## Knowledge Gaps
- **74 isolated node(s):** `__filename`, `__dirname`, `compat`, `name`, `version` (+69 more)
...
- **Why does `t()` connect `Data Engineer Landing Page` to `Layout, Header & i18n Setup`, `Project Showcase Components`, `Software Engineer Landing Page`, `Projects Data & Footer`, `Community 13`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `SUBDOMAIN_ROUTES map` connect `Software Engineer Landing Page` to `Build Config & Subdomain Routing`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `nextConfig` connect `Build Config & Subdomain Routing` to `Software Engineer Landing Page`?**
